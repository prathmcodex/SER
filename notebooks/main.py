...
model.load_state_dict(torch.load("/workspaces/SER_/models/cnn_lstm_model_imp1.pt", map_location=torch.device('cpu')))
SAMPLE_RATE = 48000
from joblib import load

scaler = load('/workspaces/SER_/models/std_scaler_imp1.bin')
